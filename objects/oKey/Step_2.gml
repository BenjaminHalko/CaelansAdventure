...
if(mode == 1)
{
	...
	x = Approch(x,xtarget,median(point_distance(x,0,xtarget,0)/distancedivede/max(keynumber*0.75,1),1,oPlayer.walksp));
	yy = Approch(yy,ytarget,median(point_distance(0,yy,0,ytarget)/distancedivede/max(keynumber*0.75,1),1,max(oPlayer.vsp/5,oPlayer.walksp*2)));
