/// @desc 
DrawIcon(room_width/2,room_height/2,Load("Info","Icon Number",0),iconscale,iconrotation,iconalpha,true);
draw_set_font(fMenu);
draw_set_color(c_white);
draw_text(room_width/2,room_height/5,"User Select");
...
for(var i = 0; i <= 3; i++)
{
	...
	var xx = margin+((room_width-(margin*2))/3)*(i+0.5);
